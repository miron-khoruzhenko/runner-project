	...
	return (
		<div className="bg-secondaryZinc p-4 rounded font-['Chakra Petch'] flex flex-col h-full">
			...
			<div className="flex flex- justify-end ">
				...
				<div 
					className={cn("z-[10] size-[25px] cursor-pointer flex items-center justify-center relative ml-auto rounded-lg p-1 hover:bg-zinc-800 bg-primaryZinc ", (isSearchActive ? 'flex w-full ' : 'aspect-square') )}
				...
				>
					...
					<div className="aspect-square  rounded-lg " >
						<img src={'/nav-icons/search.svg'} alt={'search'} className='size-2' />
					</div>
				</div>
			</div>
