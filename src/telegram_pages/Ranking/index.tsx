		...
		<div className="pl-6 lg:pl-[120px] pr-6 w-full min-h-full  flex flex-col items-center justify-start pb-[115px]">
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 w-full gap-6 h-full ">
				...
				<div className="flex flex-col gap-2 lg:gap-6">
					<UserStats
						title1={'Your place'} title2={'My score'}
	...
	return (
		<div className="mt-6 mb-6 w-full flex  justify-center items-center">
			...
			<div className="w-full relative text-left">
				<h2 className="w-max font-['Chakra Petch'] text-white text-[22px] font-bold">Total Balance</h2>
...
export default TelegramRanking;