...
const ListBlock = () => {
	...
	return (
		<div
			...
			className={cn("flex items-center gap-3 text-white p-3 cursor-pointer relative ", isModalOpen ? "bg-[#020F1B] border-l border-l-yellow rounded-t-lg" : "bg-[#2A2D2C] rounded-lg ml-px")}
		>
