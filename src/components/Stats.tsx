...
export const Stats = () => {
  ...
  return (
    <div>
      <ul className="flex w-full gap-2 lg:gap-7">
    ...
    <li className="border-2 flex-grow border-[#fff] rounded-lg relative">
      <div className="px-2 py-1 lg:p-4 flex gap-3">
        <div className=" lg:size-14 flex justify-center items-center relative">
          <div className="filter blur absolute z-[-1] rounded-full opacity-25 w-full h-full" style={{backgroundColor: bgColor}} />
          <img src={imgPath} alt="" className="size-4 lg:size-7" />
        </div>
        <div>
