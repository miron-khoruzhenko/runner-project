...
export default function MainPage({ activeWallet}:{activeWallet: string}) {
  ...
  return (
    ...
    <div className="pl-6 lg:pl-[10%] p-6 w-full flex flex-col gap-6">
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="flex flex-col w-full md:3/5 lg:w-4/5 gap-6 min-h-full">
          <Stats />
          <Projects isFullMode={isFullMode} />
        </div>
        <div className="w-full md:w-3/5 lg:w-1/5 min-w-[250px] flex justify-center items-center">
          {/* <Referral /> */}
